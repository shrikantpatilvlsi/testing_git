...
analyze -format verilog /usr/local/synopsys/Design_Compiler/K-2015.06-SP5-5/de/sim_ver/DW01_add.v
elaborate DW01_add
...
create_clock -name clk -period 2.0 -waveform [list 0 1.0] [get_ports clk]
...
set_max_delay 2.0 -from [all_inputs];
